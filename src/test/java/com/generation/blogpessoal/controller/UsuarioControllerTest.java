...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> corpoRequisição = new HttpEntity<Usuario>(new Usuario(0L,"Bruna","bruna@email.com","12345678","-"));
		
		ResponseEntity<Usuario> corpoResposta = testRestTemplate.exchange("/usuarios/cadastrar", HttpMethod.POST,corpoRequisição, Usuario.class);
	...
	public void deveAtualizarUmUsuario() {
		...
		Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get().getId(),
				"Juliana Andrews Ramos", "julaina_ramos@email.com.br", "juliana123" , "-");
